...
\\
Uppdaterad 2024-03-04 av Johan Ödesjö\\
\\
Uppdaterad 2025-05-29 av Ludwig Granstedt\\
\\
% Uppdaterad 20??-??-?? Förnamn Efternamn\\
% \\
% Efter att du ändrat bör du även se till att filen är uppdaterad på github.com/fspexet/styrdokument
\newpage 
\tableofcontents
\kapitel{Allmänt}
...
\paragraf{Entledigande}
\underparagraf{En medlem i spexet kan avsäga sig en eller flera av sina poster och på begäran entledigas av styrelsen.}
\underparagraf{En medlem i spexet kan avsäga sig sitt medlemskap och på begäran entledigas av styrelsen.}
...
\paragraf{Avsättande}
\underparagraf{För att avsätta styrelsen krävs att ärendet anslås tillsammans med den slutgiltiga föredragningslistan till ett spexmöte, samt att minst tre fjärdedelar av de närvarande vid spexmötet är ense.}
